  ...
  <div class="d-flex flex-column justify-content-between">
    <div class="row justify-content-center mt-5">
      <div class="text-center page-404">
        <div class="me-4">
            <img src="{{ asset('be/images/404.png') }}" alt="404 Error" style="max-width: 500px; margin-left: 50px;">
        </div>
        <h1 class="error-title">404</h1>
        <p class="pb-5 error-subtitle">Looks like something went wrong.</p>
        <a href="/dashboard" class="btn btn-primary btn-pill">Back to Home</a>
      </div>
    </div>
  </div>
</div>

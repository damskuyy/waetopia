...
<div class="container-fluid">
    <div class="card card-default">
        <div class="card-header">
            ...
            <a href="{{ route('paket_wisata.create') }}" class="btn btn-primary">Tambah Paket Wisata</a>
        </div>
        <div class="card-body">
                    ...
                    <tr class="text-bold text-dark">
                        ...
                        @if (strlen($data['nama_paket']) > 10) 
                                <td data-bs-toggle="tooltip" data-bs-placement="right" 
                                    data-bs-title="{{ $data['nama_paket'] }}"> 
                                    {{substr($data['nama_paket'], 0, 10) . '...' }}</td>
                            @else
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="foto1ModalLabel_{{ $data->id }}">Foto 1 - {{ $data->nama_paket }}</h5>
                            ...
                            @if ($data['foto2'] !== null)
                                ...
                                <div class="modal fade" id="foto2Modal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="foto2ModalLabel_{{ $data->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="foto2ModalLabel_{{ $data->id }}">Foto 2 - {{ $data->nama_paket }}</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                            ...
                            @if ($data['foto3'] !== null)
                                ...
                                <div class="modal fade" id="foto3Modal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="foto3ModalLabel_{{ $data->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="foto3ModalLabel_{{ $data->id }}">Foto 3 - {{ $data->nama_paket }}</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                            ...
                            @if ($data['foto4'] !== null)
                                ...
                                <div class="modal fade" id="foto4Modal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="foto4ModalLabel_{{ $data->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="foto4ModalLabel_{{ $data->id }}">Foto 4 - {{ $data->nama_paket }}</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                            ...
                            @if ($data['foto5'] !== null)
                                ...
                                <div class="modal fade" id="foto5Modal_{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="foto5ModalLabel_{{ $data->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="foto5ModalLabel_{{ $data->id }}">Foto 5 - {{ $data->nama_paket }}</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                        ...
                        <td class="text-center">
                            <a href="{{ route('paket_wisata.show', $data->id) }}" class="mdi mdi-eye" title="Detail"></a>
                            <a href="{{ route('paket_wisata.edit', $data->id) }}" class="mdi mdi-open-in-new"></a>
                            <a href="{{ route('paket_wisata.destroy', $data) }}" onclick="hapus (event, this)"

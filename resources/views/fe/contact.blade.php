...
<!-- Start All Pages -->
	...
	<div class="heading-title text-center" style="margin-top: 100px;">
		<h2>Location</h2>
		<p>Temukan lokasi desa wisata kami dan rencanakan kunjungan Anda bersama keluarga.</p>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Contact Me</h2>
						<p>Hubungi kami untuk informasi paket wisata, penginapan, dan event lokal.</p>
					</div>
				</div>
			</div>
			<div class="row">
...
@endsection
	...
	<script>
		$(document).ready(function () {
			console.log("Initializing Mapify...");
			$('.map-full').mapify({
				points: [
					{
						lat: 40.7143528,
			...
			console.log("Mapify initialized.");
		});
	</script> --}}